...
<div id="hero" class="carousel slide carousel-fade" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="${pageContext.request.contextPath}/img/sebastian-staines-6_8nhHo4fDc-unsplash.jpg" class="d-block w-100" alt="hero1">
    ...
    <div class="carousel-item">
      <img src="${pageContext.request.contextPath}/img/hero1.jpg" class="d-block w-100" alt="hero2">
      <div class="carousel-caption d-none d-md-block">
    ...
    <div class="carousel-item">
      <img src="${pageContext.request.contextPath}/img/hero2.jpg" class="d-block w-100" alt="hero3">
      <div class="carousel-caption d-none d-md-block">
	...
	<div id="gallary">
		<div class="row">
			<div class="col col-sm-12 col-md-6 col-lg-6 mb-3">
				<div class="card">
				  <img src="${pageContext.request.contextPath}/img/hero1.jpg" class="card-img-top" alt="hero1">
				  <div class="card-body">
			...
			<div class="col-12 col-sm-12 col-md-6 col-lg-6 mb-3">
				<div class="card">
					 <img src="${pageContext.request.contextPath}/img/hero2.jpg" class="card-img-top" alt="hero2">
					 <div class="card-body">
					    <h5 class="card-title">Card title</h5>
					    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
					    <a href="#" class="btn btn-primary">Go somewhere</a>
